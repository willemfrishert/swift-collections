Pod::Spec.new do |s|
  s.name         = "SwiftCollectionsDequeModule"
  s.module_name  = "DequeModule"
  s.version      = "1.1.4"
  s.summary      = "A module for Deque data structure from Swift Collections."
  s.description  = "This is the DequeModule from Swift Collections, packaged separately to avoid clashes."
